...
<!-- Bootstrap Styles-->
<link href="dashboardAssets/css/bootstrap.css" rel="stylesheet" />
<!-- FontAwesome Styles-->
<link href="dashboardAssets/css/font-awesome.css" rel="stylesheet" />
<!-- Morris Chart Styles-->
<link href="dashboardAssets/js/morris/morris-0.4.3.min.css" rel="stylesheet" />
<!-- Custom Styles-->
<link href="dashboardAssets/css/custom-styles.css" rel="stylesheet" />
<!-- Google Fonts-->
<link href='https://fonts.googleapis.com/css?family=Open+Sans'
	rel='stylesheet' type='text/css' />
<link rel="stylesheet" href="dashboardAssets/js/Lightweight-Chart/cssCharts.css">
</head>
...
<body>
			...
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					...
					<li><a class="active-menu" href="index.html"><i
							class="fa fa-dashboard"></i>共享站点参数一致性稽核</a></li>
	...
	<!-- JS Scripts-->
	<!-- jQuery Js -->
	<script src="dashboardAssets/js/jquery-1.10.2.js"></script>
	<!-- Bootstrap Js -->
	<script src="dashboardAssets/js/bootstrap.min.js"></script>

	<!-- Metis Menu Js -->
	<script src="dashboardAssets/js/jquery.metisMenu.js"></script>
	<!-- Morris Chart Js -->
	<script src="dashboardAssets/js/morris/raphael-2.1.0.min.js"></script>
	<script src="dashboardAssets/js/morris/morris.js"></script>


	<script src="dashboardAssets/js/easypiechart.js"></script>
	<script src="dashboardAssets/js/easypiechart-data.js"></script>

	<script src="dashboardAssets/js/Lightweight-Chart/jquery.chart.js"></script>

	<!-- Custom Js -->
	<script src="dashboardAssets/js/custom-scripts.js"></script>


	<!-- Chart Js -->
	<script type="text/javascript" src="dashboardAssets/js/Chart.min.js"></script>
	<script type="text/javascript" src="dashboardAssets/js/chartjs.js"></script>
